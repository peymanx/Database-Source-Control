...
namespace Barsa.EndUserGitUI.Git
{
    public static class ProgressManager
    {
        ...
        public static void Start(string title)
        {
            ...
            _titleLabel.Font =
                new Font("Tahoma", 11F, FontStyle.Bold);
            ...
            footer.Text =
                "لطفاً تا پایان عملیات پنجره را نبندید...";
            ...
            // اطمینان از قرار گرفتن روی پنجره‌های دیگر
            _form.TopMost = true;
            _form.Activate();
            _form.BringToFront();
